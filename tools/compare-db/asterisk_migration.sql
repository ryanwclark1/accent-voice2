...
CREATE TABLE mail (
    ...
    origin character varying(255) DEFAULT 'accent-clients.accentservices.com'::character varying NOT NULL,
...
CREATE TABLE resolvconf (
    id integer NOT NULL,
    hostname character varying(63) DEFAULT 'accent'::character varying NOT NULL,
...
--
-- Name: stats_conf_accentuser; Type: TABLE; Schema: public; Owner: asterisk; Tablespace: 
--

CREATE TABLE stats_conf_accentuser (
    stats_conf_id integer NOT NULL,
    user_id integer NOT NULL
);


ALTER TABLE public.stats_conf_accentuser OWNER TO asterisk;
...
__switchboard_directory	Switchboard	accent_entity	others	0	
\.
...
1	default	accentdir,internal	Display	Contexte par défaut	1
2	__switchboard_directory	accentdir	switchboard		1
\.
...
1	accentdir	phonebook		["phonebook.firstname","phonebook.lastname","phonebook.displayname","phonebook.society","phonebooknumber.office.number"]	["phonebooknumber.office.number","phonebooknumber.mobile.number"]	Répertoire Accent Externe	1
2	internal	internal		["userfeatures.firstname","userfeatures.lastname"]		Répertoire Accent Interne	1
\.
...
1	Display	{"10": [ "Nom","","","{db-firstname} {db-lastname}" ],"20": [ "Numéro","phone","","{db-phone}" ],"30": [ "Entreprise","","Inconnue","{db-company}" ],"40": [ "E-mail","","","{db-mail}" ], "50": [ "Source","","","{accent-directory}" ]}	1	Affichage par défaut
...
1	accentcti	127.0.0.1	5038	accent_cti_user	phaickbebs9	0.0.0.0	5003	1	0.0.0.0	5013	1	127.0.0.1	5004	1	127.0.0.1	5005	1			10	5	1	1
\.
...
1	accent	De base non supprimable	0
\.
...
4	Accent	Modèle de fiche de base.	dest	{"10": [ "Nom","title","","{accent-calleridname}",0 ],"20": [ "Numéro","text","","{accent-calleridnum}",0 ],"30": [ "Origine","text","","{accent-origin}",0 ]}	{"10": [ "Nom","title","","{accent-calledidname}" ],"20": [ "Numéro","body","","{accent-calleridnum}" ],"30": [ "Origine","body","","{accent-origin}" ]}		{}	0	1	1
1	dial	sheet_action_dial	dest	{}	{}		{}	0	1	0
3	custom1	sheet_action_custom1	all	{}	{}		{}	0	1	0
2	queue	sheet_action_queue	dest	{}	{}	file:///etc/accent/ctiservers/form.ui	{}	0	1	0
\.
...
1	internal	\N	internal		Accent internal users
2	phonebook	\N	phonebook		Accent phonebook
\.
...
2	1	accent-features	_*31.	extenfeatures	agentstaticlogin
3	1	accent-features	_*32.	extenfeatures	agentstaticlogoff
4	1	accent-features	_*30.	extenfeatures	agentstaticlogtoggle
5	0	accent-features	_*37.	extenfeatures	bsfilter
6	0	accent-features	_*664.	extenfeatures	callgroup
7	1	accent-features	*34	extenfeatures	calllistening
8	0	accent-features	_*667.	extenfeatures	callmeetme
9	0	accent-features	_*665.	extenfeatures	callqueue
10	1	accent-features	*26	extenfeatures	callrecord
11	0	accent-features	_*666.	extenfeatures	calluser
12	0	accent-features	*36	extenfeatures	directoryaccess
13	0	accent-features	*25	extenfeatures	enablednd
14	0	accent-features	*90	extenfeatures	enablevm
17	0	accent-features	_*90.	extenfeatures	enablevmslt
18	0	accent-features	_*23.	extenfeatures	fwdbusy
19	0	accent-features	_*22.	extenfeatures	fwdrna
20	0	accent-features	_*21.	extenfeatures	fwdunc
21	0	accent-features	*20	extenfeatures	fwdundoall
25	0	accent-features	*48378	extenfeatures	autoprov
26	0	accent-features	*27	extenfeatures	incallfilter
27	0	accent-features	*10	extenfeatures	phonestatus
28	0	accent-features	_*735.	extenfeatures	phoneprogfunckey
29	0	accent-features	_*8.	extenfeatures	pickup
33	0	accent-features	*9	extenfeatures	recsnd
34	0	accent-features	_*99.	extenfeatures	vmboxmsgslt
35	1	accent-features	_*93.	extenfeatures	vmboxpurgeslt
37	0	accent-features	*98	extenfeatures	vmusermsg
36	0	accent-features	_*97.	extenfeatures	vmboxslt
38	1	accent-features	*92	extenfeatures	vmuserpurge
39	1	accent-features	_*92.	extenfeatures	vmuserpurgeslt
40	0	accent-features	_*96.	extenfeatures	vmuserslt
41	0	accent-features	_*11.	extenfeatures	paging
\.
...
4	0	0	0	musiconhold.conf	default	directory	/var/lib/accent/moh/default
\.
...
3	0	0	0	sip.conf	general	autocreate_context	accent-initconfig
...
17	0	0	0	sip.conf	general	realm	accent
18	0	0	0	sip.conf	general	alwaysauthreject	no
19	0	0	0	sip.conf	general	useragent	Accent PBX
20	0	0	0	sip.conf	general	buggymwi	no
21	0	0	1	sip.conf	general	regcontext	\N
22	0	0	0	sip.conf	general	callerid	accent
...
29	0	0	0	voicemail.conf	general	serveremail	accent
30	0	0	0	voicemail.conf	general	charset	UTF-8
31	0	0	0	voicemail.conf	general	fromstring	Accent PBX
33	0	0	0	voicemail.conf	general	pbxskip	no
34	0	0	0	voicemail.conf	general	emailsubject	Messagerie Accent
...
36	0	0	0	voicemail.conf	general	pagerfromstring	Accent PBX
...
--
-- Data for Name: stats_conf_accentuser; Type: TABLE DATA; Schema: public; Owner: asterisk
--

COPY stats_conf_accentuser (stats_conf_id, user_id) FROM stdin;
\.
...
1	root	secret	root	1	0	1409084546	0		\N
\.
...
--
-- Name: stats_conf_accentuser_pkey; Type: CONSTRAINT; Schema: public; Owner: asterisk; Tablespace: 
--

ALTER TABLE ONLY stats_conf_accentuser
    ADD CONSTRAINT stats_conf_accentuser_pkey PRIMARY KEY (stats_conf_id, user_id);
...
--
-- Name: stats_conf_accentuser; Type: ACL; Schema: public; Owner: asterisk
--

REVOKE ALL ON TABLE stats_conf_accentuser FROM PUBLIC;
REVOKE ALL ON TABLE stats_conf_accentuser FROM asterisk;
GRANT ALL ON TABLE stats_conf_accentuser TO asterisk;
