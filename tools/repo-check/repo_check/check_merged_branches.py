...
from repo_check.git import display_branches, fetch_all_repositories, find_repo_merged_branches
...
def _find_merged_branches(directory):
    ...
    for repository in accent_repositories:
        ...
        current_leftover = [(repository, branch) for branch in find_repo_merged_branches(repository_path)]
