...
accent_create_config = load_from_sbin('accent-create-config')
...
def test_load_config_dhcp(ifaddresses):
    ...
    result = accent_create_config.load_config_dhcp(session)
...
def test_load_config_smtp():
    ...
    session = MockSession()
    result = accent_create_config.load_config_smtp(session)
...
def test_load_config_smtp_when_empty():
    ...
    session = MockSession(mydomain='', origin='', relayhost='', fallback_relayhost='', canonical='')
    result = accent_create_config.load_config_smtp(session)
...
def test_load_config_provisioning():
    ...
    session = MockSession()
    result = accent_create_config.load_config_provisioning(session)
...
def test_load_config_monitoring():
    ...
    session = MockSession()
    result = accent_create_config.load_config_monitoring(session)
...
def test_load_config_resolvconf():
    ...
    session = MockSession()
    result = accent_create_config.load_config_resolvconf(session)
...
def test_load_config_netiface():
    ...
    session = MockSession()
    result = accent_create_config.load_config_netiface(session)
