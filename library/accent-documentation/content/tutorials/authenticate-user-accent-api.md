---
title: How to Authenticate a User From Accent APIs
date: 2022-06-22 10:00:00
author: Pascal Cadotte Michaud
category: Developer Tutorial
slug: authenticate-user-accent-api
ogimage: authenticate-user-accent-api-og.jpg
thumbnail: authenticate-user-accent-api-thumbnail.jpg
status: published
---
...
mechanism. As an API consumer of Accent Platform, the first step you need to do before almost anything
else is to authenticate.

## How To Authenticate a User

The process of authentication on Accent Platform is basically creating a token using your username and
password. This can be done using the `POST /api/auth/0.1/token` API of accent-auth.
...
manages accent-auth users. You'll get familiar with all common operations GET, CREATE, UPDATE and
DELETE. See the [Authentication API
specifications](https://accentvoice.io/documentation/api/authentication.html) for more.

## Conclusion

If you are developing a long-lived application that uses Accent Platform's API, then you should use
...
- Original content of this tutorial comes from the [Refresh Token in
  Accent](/blog/accent-auth-refresh-token) blog post.
- [API specifications](https://accentvoice.io/documentation/)
