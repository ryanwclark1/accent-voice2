...
from accent_bus.resources.services import event
...
class TestFindIpAddress(unittest.TestCase):
    def test_that_the_main_iface_is_used_if_it_has_an_ip_address(self):
        with patch("accent.consul_helpers.netifaces") as netifaces:
...
class TestNotifyingRegisterer(unittest.TestCase):
    ...
    @patch("accent.consul_helpers.Consul", Mock())
    ...
    @patch("accent.consul_helpers.Consul")
...
@patch("accent.consul_helpers.requests")
...
class TestRemoteServiceFinderListRunningServices(BaseFinderTestCase):
    ...
    def test_that_returns_services_from_each_nodes(self, requests):
        node_0_service = {
            ...
            "Tags": ["f9f0f3bb-f577-4354-9109-9cf6cf7c7adf", "accent-calld"],
            "Port": 9495,
            "Address": "10.37.0.254",
        ...
        node_1_service = {
            ...
            "Service": "accent-calld",
            "Tags": ["f9f0f3bb-f577-4354-b1b1-9cf6cf7c7adf", "accent-calld"],
            "Port": 9495,
            "Address": "10.37.1.254",
            "EnableTagOverride": False,
        }
        ...
        finder = ServiceFinder(self.consul_config)
        result = finder._list_running_services("accent-calld", "dc1", None)
