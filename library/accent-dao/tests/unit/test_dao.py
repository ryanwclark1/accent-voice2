...
from accent.debug import trace_duration
...
from accent_dao.alchemy.cel import CEL as CELSchema
...
from accent_dao.alchemy.rightcallmember import RightCallMember as CallPermissionAssociation
from accent_dao.alchemy.sccpdevice import SCCPDevice as SCCPDeviceSchema
...
from accent_dao.alchemy.voicemail import Voicemail as VoicemailSchema
...
TEST_DB_URL = os.getenv('ACCENT_TEST_DB_URL', 'postgresql://asterisk:asterisk@localhost/asterisktest')
...
class ItemInserter:
    ...
    def add_infos(self, **kwargs):
        kwargs.setdefault('accent_version', 'dev')
        infos = Infos(**kwargs)
        self.add_me(infos)
        return infos
