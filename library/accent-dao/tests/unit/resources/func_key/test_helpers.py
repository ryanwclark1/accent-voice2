...
from accent_dao.alchemy.func_key import FuncKey as FuncKeySchema
from accent_dao.alchemy.func_key_dest_agent import (
    FuncKeyDestAgent as FuncKeyDestAgentSchema,
)
from accent_dao.alchemy.func_key_dest_bsfilter import (
    FuncKeyDestBSFilter as FuncKeyDestBSFilterSchema,
)
from accent_dao.alchemy.func_key_dest_conference import (
    FuncKeyDestConference as FuncKeyDestConferenceSchema,
)
from accent_dao.alchemy.func_key_dest_custom import (
...
from accent_dao.alchemy.func_key_dest_forward import (
    FuncKeyDestForward as FuncKeyDestForwardSchema,
)
from accent_dao.alchemy.func_key_dest_group import (
...
from accent_dao.alchemy.func_key_dest_paging import (
    FuncKeyDestPaging as FuncKeyDestPagingSchema,
)
from accent_dao.alchemy.func_key_dest_park_position import (
    FuncKeyDestParkPosition as FuncKeyDestParkPositionSchema,
)
from accent_dao.alchemy.func_key_dest_queue import (
    FuncKeyDestQueue as FuncKeyDestQueueSchema,
)
from accent_dao.alchemy.func_key_dest_service import (
    FuncKeyDestService as FuncKeyDestServiceSchema,
)
from accent_dao.alchemy.func_key_dest_user import FuncKeyDestUser as FuncKeyDestUserSchema
from accent_dao.alchemy.func_key_mapping import FuncKeyMapping as FuncKeyMappingSchema
