# file: accent_dao/resources/feature_extension/search.py
...
config = SearchConfig(
    ...
    columns={
        "exten": FeatureExtension.exten,
        "feature": FeatureExtension.feature,
        "enabled": FeatureExtension.enabled,
    },
    search=[
        "exten",
        "feature",
...
feature_extension_search = AsyncSearchSystem(config)
