...
@cached_query()
@daosession
def get_authorized_subnets(session: Session) -> list[str]:
    """Retrieve all authorized subnets for phonebook access.
...
@cached_query()
@async_daosession
async def async_get_authorized_subnets(session: AsyncSession) -> list[str]:
...
@daosession
def add_authorized_subnet(session: Session, host: str) -> AccessFeatures:
    """Add a new authorized subnet for phonebook access.
...
@async_daosession
async def async_add_authorized_subnet(
...
@daosession
def remove_authorized_subnet(session: Session, host: str) -> bool:
    """Remove an authorized subnet for phonebook access.
...
@async_daosession
async def async_remove_authorized_subnet(session: AsyncSession, host: str) -> bool:
