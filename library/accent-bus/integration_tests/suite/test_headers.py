...
class TestHeaders(BusIntegrationTest):
    ...
    def test_routing_key_disabled_with_headers_exchange(self) -> None:
    ...
    def test_extra_headers_required(self) -> None:
    ...
    def test_publish_wrong_expected_headers_value(self) -> None:
    ...
    def test_publish_ignore_extra_headers(self) -> None:
    ...
    def test_same_event_multiple_headers(self) -> None:
    ...
    def test_publish_queue(self) -> None:
    ...
    def test_event_marshaller(self) -> None:
    ...
    def test_event_unmarshaller(self) -> None:
