...
class TestRoutingKey(BusIntegrationTest):
    ...
    def test_good_routing_key(self) -> None:
    ...
    def test_wrong_routing_key(self) -> None:
    ...
    def test_no_event_routing_key(self) -> None:
    ...
    def test_no_routing_key(self) -> None:
    ...
    def test_headers_disabled_when_using_routing_key(self) -> None:
    ...
    def test_message_marshalling(self) -> None:
        event = MockEvent(
    ...
    def test_message_unmarshalling(self) -> None:
