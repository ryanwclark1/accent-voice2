...
class ClientTest(unittest.TestCase):
    ...
    @httpretty.activate
    def test_get(self):
        httpretty.register_uri(httpretty.GET, "http://swagger.py/swagger-test/pet", body='[]')
    ...
    def test_multiple(self):
        httpretty.register_uri(httpretty.GET, "http://swagger.py/swagger-test/pet/find", body='[]')
    ...
    def test_delete(self):
        httpretty.register_uri(
            httpretty.DELETE, "http://swagger.py/swagger-test/pet/1234", status=requests.codes.no_content
        )
                                ...
                                "operations": [
                                    {
                                        "httpMethod": "DELETE",
                                        "nickname": "deletePet",
                                        "parameters": [{"name": "petId", "paramType": "path"}],
                                    }
                                ],
                            },
                        ],
