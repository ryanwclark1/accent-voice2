...
"""Conference bridge default user command module for the Configuration Daemon API."""
...
class ConfBridgeAccentDefaultUserCommand(RESTCommand):
    """Command for managing conference bridge default user settings."""

    resource = "asterisk/confbridge/accent_default_user"

    def get(self) -> dict[str, Any]:
        """Get conference bridge default user settings.

        Returns:
            Conference bridge default user settings
    ...
    async def get_async(self) -> dict[str, Any]:
        """Get conference bridge default user settings asynchronously.
    ...
    def update(self, body: dict[str, Any]) -> None:
        """Update conference bridge default user settings.

        Args:
            body: Conference bridge default user settings
    ...
    async def update_async(self, body: dict[str, Any]) -> None:
        """Update conference bridge default user settings asynchronously.
