...
from accent_amid.ami.parser import parse_buffer, parse_command_response
...
class TestParser(unittest.TestCase):
    ...
    def test_given_valid_command_response_when_parse_command_response_then_command_response_returned(
        ...
        msg = textwrap.dedent(
            ...
            Output: 	Mode: files\r
            Output: 	Directory: /var/lib/accent/moh/default\r
            \r
            '''
        ).encode('utf-8')
        ...
        assert_that(
            ...
            contains_exactly(
                'Class: default',
                '	Mode: files',
                '	Directory: /var/lib/accent/moh/default',
            ),
        )
