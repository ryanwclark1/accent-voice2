...
from accent_amid import auth, rest_api
from accent_amid.ami.client import AMIClient
from accent_amid.bus.client import BusClient
from accent_amid.facade import EventHandlerFacade
...
class Controller:
    ...
    def stop(self, reason: str) -> None:
        logger.warning('Stopping accent-amid: %s', reason)
