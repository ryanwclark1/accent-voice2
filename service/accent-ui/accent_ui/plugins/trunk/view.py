...
from accent_ui.plugins.sip_template.view import EXCLUDE_CHOICE_SECTIONS, SECTIONS
...
class TrunkView(BaseIPBXHelperView):
    ...
    @menu_item(
        '.ipbx.call_management.trunks', l_('Trunks'), icon="server", svg="M5.25 14.25h13.5m-13.5 0a3 3 0 0 1-3-3m3 3a3 3 0 1 0 0 6h13.5a3 3 0 1 0 0-6m-16.5-3a3 3 0 0 1 3-3h13.5a3 3 0 0 1 3 3m-19.5 0a4.5 4.5 0 0 1 .9-2.7L5.737 5.1a3.375 3.375 0 0 1 2.7-1.35h7.126c1.062 0 2.062.5 2.7 1.35l2.587 3.45a4.5 4.5 0 0 1 .9 2.7m0 0a3 3 0 0 1-3 3m0 3h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Zm-3 6h.008v.008h-.008v-.008Zm0-6h.008v.008h-.008v-.008Z", multi_tenant=True
    )
    def index(self):
        return super().index()
