...
_DEFAULT_CONFIG: WebhookdConfigDict = {
    ...
    'db_uri': (
        ...
        'application_name=accent-webhookd'
    ),
    'rest_api': {
        'listen': '127.0.0.1',
