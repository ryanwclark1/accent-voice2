...
@patch('accent_webhookd.plugins.mobile.http.Tenant')
...
@patch('accent_webhookd.plugins.mobile.http.notification_schema')
@patch('accent_webhookd.plugins.mobile.http.send_notification')
def test_post(
