...
from accent.mallow.validate import Length, OneOf, validate_string_dict
from accent.mallow_helpers import ListSchema
...
class SubscriptionSchema(Schema):
    ...
    events_accent_uuid = fields.String(validate=Length(equal=36), missing=None)
