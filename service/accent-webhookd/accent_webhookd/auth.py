...
from accent.auth_verifier import AuthServerUnreachable, required_tenant
...
class MasterTenantNotInitializedException(APIException):
    def __init__(self):
        msg = 'accent-webhookd master tenant is not initialized'
...
class Token:
    ...
    @property
    def accent_uuid(self) -> str:
        return self._token_info['accent_uuid']
