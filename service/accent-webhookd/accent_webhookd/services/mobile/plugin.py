...
from accent_webhookd.services.helpers import (
    HookExpectedError,
    HookRetry,
    RequestDetailsDict,
...
DEFAULT_ANDROID_CHANNEL_ID = 'io.accent.songbird'
...
class Service:
    ...
    def get_auth(cls, config: WebhookdConfigDict) -> tuple[AuthClient, str]:
        ...
        token: TokenDict = auth.token.new('accent_user', expiration=3600)
