...
class TestSendViaFcmLegacy(TestCase):
    ...
    @patch('accent_webhookd.services.mobile.plugin.FCMNotificationLegacy')
...
class TestSendViaFCMv1(TestCase):
    ...
    @patch('accent_webhookd.services.mobile.plugin.json.loads')
    @patch('accent_webhookd.services.mobile.plugin.FCMNotification')
