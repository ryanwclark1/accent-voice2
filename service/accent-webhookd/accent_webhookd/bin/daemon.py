...
from accent_webhookd import config
from accent_webhookd.controller import Controller
...
def main():
    ...
    accent_logging.silence_loggers(['Flask-Cors', 'urllib3', 'amqp'], logging.WARNING)
