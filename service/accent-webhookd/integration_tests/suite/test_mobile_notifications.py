...
from accent_webhookd_client.exceptions import WebhookdError
...
class TestNotifications(BaseIntegrationTest):
    ...
    def setUp(self):
        ...
        requests.post(
            ...
            headers={'Accent-Tenant': USERS_TENANT},
        )
    ...
    def test_can_send_notification_android_legacy(self) -> None:
        ...
        expected_payload_body = {
            ...
            'notification': {
                "android_channel_id": "io.accent.songbird",
                "badge": 1,
                "body": "test message",
                "title": "test title",
            },
