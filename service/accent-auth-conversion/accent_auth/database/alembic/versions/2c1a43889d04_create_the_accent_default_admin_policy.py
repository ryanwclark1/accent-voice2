"""create the accent_default_admin_policy
...
POLICY_NAME = 'accent_default_admin_policy'
POLICY_DESCRIPTION = '''\
Default Accent policy for administrator authentification backends

Do not modify this policy, it can be modified in future Accent upgrades
'''
...
def upgrade():
    ...
    if True:
        # NOTE: Since 21.05 default policies are not managed by the database anymore
