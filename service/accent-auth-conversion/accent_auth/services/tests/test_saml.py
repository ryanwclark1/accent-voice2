...
from accent_auth.database.queries.saml_pysaml2_cache import SAMLPysaml2CacheDAO
from accent_auth.database.queries.saml_session import SAMLSessionDAO
...
class TestSAMLService(TestCase):
    ...
    @patch('accent_auth.services.SAMLService.get_client')
