...
from accent.auth_verifier import Unauthorized, required_tenant
from accent.auth_verifier import required_acl as _required_acl
from accent.flask.auth_verifier import AuthVerifierFlask
from accent.rest_api_helpers import handle_api_exception
...
from accent_auth.database.helpers import commit_or_rollback
...
def trigger_profiling(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        directory = '/tmp/accent-profiling'
