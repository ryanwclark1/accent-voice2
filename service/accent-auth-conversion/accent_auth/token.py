...
from accent_bus.resources.auth.events import SessionDeletedEvent, SessionExpireSoonEvent

from accent_auth.database.helpers import Session
...
class Token:
    ...
    def __eq__(self, other):
        return (
            ...
            and self.accent_uuid == other.accent_uuid
    ...
    def to_dict(self):
        result = {
            ...
            'accent_user_uuid': self.pbx_user_uuid,
            'accent_uuid': self.accent_uuid,
