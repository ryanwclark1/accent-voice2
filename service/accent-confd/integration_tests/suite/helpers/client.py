...
class RestUrlClient(UrlFragment):
    ...
    def get(self, token=None, accent_tenant=None, **params):
        url = str(self)
        params = self._merge_params(params, self.body)
        if accent_tenant:
            params['headers'] = {'Accent-Tenant': accent_tenant}
        if token:
            params['headers'] = {'X-Auth-Token': token}
        return self.client.get(url, **params)

    def post(self, body=None, token=None, accent_tenant=None, **params):
        url = str(self)
        params = self._merge_params(params, body, self.body)
        headers = {}
        if accent_tenant:
            headers['Accent-Tenant'] = accent_tenant
        if token:
            headers['X-Auth-Token'] = token
        headers = headers or None
        return self.client.post(url, params, headers=headers)

    def put(self, body=None, query_string=None, token=None, accent_tenant=None, **params):
        url = str(self)
        params = self._merge_params(params, body, self.body)
        headers = {}
        if accent_tenant:
    ...
    def delete(self, token=None, accent_tenant=None, **params):
        url = str(self)
        headers = {}
        if accent_tenant:
            headers['Accent-Tenant'] = accent_tenant
