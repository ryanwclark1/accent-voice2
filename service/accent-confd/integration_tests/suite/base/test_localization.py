...
def test_tenant_isolation():
    ...
    confd.localization.put({'country': 'CA'}, accent_tenant=tenant_uuid_1)
    confd.localization.put({'country': 'FR'}, accent_tenant=tenant_uuid_2)

    result_1 = confd.localization.get(accent_tenant=tenant_uuid_1)
    result_2 = confd.localization.get(accent_tenant=tenant_uuid_2)
