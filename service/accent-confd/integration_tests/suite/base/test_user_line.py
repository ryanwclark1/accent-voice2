...
@fixtures.context(accent_tenant=MAIN_TENANT, name='main-internal')
@fixtures.context(accent_tenant=SUB_TENANT, name='sub-internal')
...
def test_associate_multi_tenant(main_context, sub_context, main_user, sub_user):
    @fixtures.line_sip(context=main_context, accent_tenant=MAIN_TENANT)
    @fixtures.line_sip(context=sub_context, accent_tenant=SUB_TENANT)
...
def test_dissociate_multi_tenant(main_internal, sub_internal, main_user, sub_user):
    @fixtures.line_sip(context=main_internal, accent_tenant=MAIN_TENANT)
    @fixtures.line_sip(context=sub_internal, accent_tenant=SUB_TENANT)
    def aux(main_line, sub_line):
        response = (
            confd.users(sub_user['id'])
            .lines(main_line['id'])
