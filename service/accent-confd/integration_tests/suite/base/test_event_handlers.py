...
def test_create_default_templates_when_not_exist():
    response = confd.endpoints.sip.templates.get(accent_tenant=CREATED_TENANT)
    ...
    def slug_created():
        ...
        response = confd.groups.post({'label': 'ignore'}, accent_tenant=CREATED_TENANT)
...
@unittest.skip
@fixtures.context(name='deleted_ctx', accent_tenant=DELETED_TENANT)
@fixtures.user(accent_tenant=DELETED_TENANT)
@fixtures.line(context='deleted_ctx', accent_tenant=DELETED_TENANT)
@fixtures.sip(accent_tenant=DELETED_TENANT)
@fixtures.extension(context='deleted_ctx', accent_tenant=DELETED_TENANT)
@fixtures.device(accent_tenant=DELETED_TENANT)
