...
from accent_confd.plugins.endpoint_custom.schema import CustomSchema  # noqa
from accent_confd.plugins.endpoint_sccp.resource import SccpSchema  # noqa
from accent_confd.plugins.endpoint_sip.schema import EndpointSIPSchema  # noqa
...
class TestUserLineNotifier(unittest.TestCase):
    ...
    @patch('accent_confd.plugins.user_line.notifier.UserSchema.dump')
