...
from accent_confd.plugins.endpoint_sip.schema import EndpointSIPSchema
from accent_confd.plugins.extension.schema import ExtensionSchema
from accent_confd.plugins.user.schema import UserSchema, UserSchemaNullable
from accent_confd.plugins.voicemail.schema import VoicemailSchema

from .accent_user_schema import AccentUserSchema
...
class AccentUserCreator(Creator):
    schema = AccentUserSchema
