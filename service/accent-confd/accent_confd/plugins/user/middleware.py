...
class UserMiddleWare(ResourceMiddleware):
    def __init__(self, service, accent_user_service, middleware_handle):
        super().__init__(service, UserListItemSchema(), update_schema=UserSchema())
        self._accent_user_service = accent_user_service
    ...
    def create(self, body, tenant_uuid, tenant_uuids):
        ...
        if auth:
            ...
            user_dict['auth'] = self._accent_user_service.create(auth)
    ...
    def delete(self, user_id, tenant_uuid, tenant_uuids, recursive=False):
        ...
        if not recursive:
            ...
            try:
                self._accent_user_service.delete(user.uuid)
