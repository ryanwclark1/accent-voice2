...
from ..user_import.accent_user_service import build_service as build_accent_user_service
...
class Plugin:
    def load(self, dependencies):
        ...
        user_middleware = UserMiddleWare(service, accent_user_service, middleware_handle)
