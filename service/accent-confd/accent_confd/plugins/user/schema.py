...
from accent_confd.helpers.mallow import BaseSchema, Link, ListLink, Nested, StrictBoolean
from accent_confd.helpers.validator import LANGUAGE_REGEX
from accent_confd.plugins.agent.schema import (
    NUMBER_REGEX,
    AgentSchema,
)
...
class AccentAuthUserSchema(BaseSchema):
...
class UserListItemSchema(UserSchemaNullable):
    auth = Nested('AccentAuthUserSchema')
