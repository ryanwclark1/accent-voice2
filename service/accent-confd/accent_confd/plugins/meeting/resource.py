...
from accent_confd.auth import master_tenant_uuid, no_auth, required_acl
from accent_confd.helpers.restful import ItemResource, ListResource, ListSchema
...
class MeetingList(ListResource, _SchemaMixin, _MeResourceMixin):
    ...
    def add_endpoint_to_form(self, form):
        ...
        context = 'accent-meeting-guest'
        endpoint_name = endpoint_username = 'accent-meeting-{}-guest'.format(form['uuid'])
        endpoint_body = {
            'name': endpoint_name,
