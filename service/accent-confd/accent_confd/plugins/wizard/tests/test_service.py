...
class TestWizardService(unittest.TestCase):
    ...
    @patch('accent_confd.plugins.wizard.service.netifaces')
    ...
    def test_get_timezone(self):
        with patch(
            'accent_confd.plugins.wizard.service.open',
    ...
    @patch('accent_confd.plugins.wizard.service.open', create=True)
    ...
    @patch('accent_confd.plugins.wizard.service.socket')
