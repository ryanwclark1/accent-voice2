...
from accent_dao.resources.trunk import dao as trunk_dao_module
from accent_dao.resources.voicemail import dao as voicemail_dao_module

from accent_confd.database import agent_status_login as agent_login_status_dao_module
