...
API_VERSION = '1.1'
WIZARD_KEY_FILE = '/var/lib/accent-auth-keys/accent-wizard-key.yml'

DEFAULT_CONFIG = {
    'debug': False,
    'user': 'www-data',
    'log_level': 'info',
    'config_file': '/etc/accent-confd/config.yml',
    'extra_config_files': '/etc/accent-confd/conf.d/',
    'log_filename': '/var/log/accent-confd.log',
    'rest_api': {
        'profile': None,
        'listen': '127.0.0.1',
        'port': 9486,
    ...
    'auth': {
        ...
        'prefix': None,
        'https': False,
        'key_file': '/var/lib/accent-auth-keys/accent-confd-key.yml',
    },
    'ari': {
        'host': 'localhost',
        'port': 5039,
