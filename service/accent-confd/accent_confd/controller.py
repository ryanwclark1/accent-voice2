...
class Controller:
    def __init__(self, config):
        ...
        plugin_helpers.load(
            namespace='accent_confd.plugins',
    ...
    def run(self):
        logger.info('accent-confd starting...')
        accent_dao.init_db_from_config(self.config)
    ...
    def stop(self, reason):
        logger.warning('Stopping accent-confd: %s', reason)
