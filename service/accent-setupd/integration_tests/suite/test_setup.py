...
class TestSetupErrors(BaseIntegrationTest):
    ...
    def test_setup_invalid_credentials(self):
        ...
        body = {
            ...
            'nestbox_instance_name': 'my-accent',
            'nestbox_engine_host': 'accent.example.com',
    ...
    def test_setup_when_more_than_three_nameservers(self):
        ...
        confd.set_wizard_discover({"nameservers": ['10.2.2.2', '10.2.2.3', '10.2.2.4', '10.2.2.5']})
                ...
                requests=has_item(
                    has_entries(
                        ...
                        json=has_entries(
                            ...
                            private_port=6666,
                            public_host='accent.example.com',
                            public_port=6666,
                            service_id=1,
                            username='root',
                        ),
            ...
            has_entries(
                requests=has_items(
                    has_entries(
                        method='POST',
                        path='/services',
                        json={'accent-auth': 'restart', 'accent-webhookd': 'restart'},
                    )
                )
            ),
        )
...
class TestSetupNotSelfStop(BaseIntegrationTest):
    ...
    def test_setup_invalid_does_not_stop(self):
        ...
        try:
            ...
            raise AssertionError('accent-setupd stopped after failed setup')
