...
_DEFAULT_CONFIG: ProvdConfigDict = {
    'config_file': '/etc/accent-provd/config.yml',
    'extra_config_files': '/etc/accent-provd/conf.d',
    'general': {
        'advertised_http_url': None,
        'base_raw_config': {},
        'base_raw_config_file': '/etc/accent-provd/base_raw_config.json',
        'request_config_dir': '/etc/accent-provd',
        'cache_dir': '/var/cache/accent-provd',
        'cache_plugin': True,
        'check_compat_min': True,
        'check_compat_max': True,
        'base_storage_dir': '/var/lib/accent-provd',
        'plugin_server': 'http://provd.accentvoice.io/plugins/2/stable/',
    ...
    'auth': {
        ...
        'prefix': None,
        'https': False,
        'key_file': '/var/lib/accent-auth-keys/accent-provd-key.yml',
    },
    'database': {
        'type': 'json',
        'generator': 'default',
