...
from accent_provd.devices.schemas import ConfigSchema
from accent_provd.persist.common import ID_KEY
from accent_provd.persist.util import ForwardingDocumentCollection
...
if TYPE_CHECKING:
    ...
    from accent_provd.devices.schemas import ConfigDict
...
the 'X_accent_' namespace:

X_accent_phonebook_ip [optional]
  Remote Accent phonebook service
...
# accent-htek, accent-aastra, accent-alcatel, accent-avaya, accent-cisco-sccp, accent-cisco-spa, accent-fanvil,
# accent-grandstream, accent-jitsi, accent-panasonic, accent-patton, accent-polycom, accent-snom,
# accent-technicolor, accent-yealink, accent-zenitel
