...
_URL_META_FORMAT = (
    ...
    '{qs_prefix}accent_user_uuid={{user_uuid}}{qs_suffix}'
)


def add_accent_phonebook_url(
    ...
    add_accent_phonebook_url_from_format(raw_config, url_format)
