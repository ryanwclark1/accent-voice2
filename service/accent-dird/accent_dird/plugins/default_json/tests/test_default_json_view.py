...
from accent_dird.helpers import DisplayColumn
from accent_dird.plugins.tests.base_http_view_test_case import BaseHTTPViewTestCase
...
class TestJsonViewPlugin(BaseHTTPViewTestCase):
    ...
    def test_that_load_with_no_lookup_service_does_not_add_route(self):
        ...
        assert_that(self.api.add_resource.call_args_list, not_(has_item(call(Lookup, ANY))))
...
class TestFormatResult(unittest.TestCase):
    ...
    def test_that_format_results_marks_favorites(self):
        ...
        result = formatter.format_results([result1, result2], {'my_source': ['2'], 'my_other_source': ['1', '2', '3']})
