...
class TestLookupServicePlugin(unittest.TestCase):
    ...
    @patch('accent_dird.plugins.lookup_service.plugin._LookupService')
    ...
    def test_that_load_injects_config_to_the_service(self, MockedLookupService):
        ...
        MockedLookupService.assert_called_once_with(sentinel.config, self._source_manager, sentinel.controller)
