...
class Office365Plugin(BaseSourcePlugin):
    def load(self, dependencies):
        ...
        self._SourceResult = make_result_class('office365', self.name, self.unique_column, format_columns)
    ...
    def search(self, term, args=None):
        ...
        # NOTE: We need to make sure that `givenName` key/value exists to avoid TypeError when sorting
