...
from accent_dird import BaseServicePlugin, database, exception
...
class _PersonalService:
    ...
    def create_contacts(self, contact_infos, user_uuid):
        errors = []
        to_add = []
        existing_contact_uuids = {contact['id'] for contact in self._crud.list_personal_contacts()}

        for contact_info in contact_infos:
            try:
                if None in contact_info:
