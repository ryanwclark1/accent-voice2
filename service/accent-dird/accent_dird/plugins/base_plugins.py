...
from accent_dird.config import Config as MainConfig
from accent_dird.plugin_manager import ServiceDependencies
...
class BaseSourcePlugin(metaclass=abc.ABCMeta):
    """
    A backend plugin in accent should implement this base class implicitly or
    explicitly
    """
