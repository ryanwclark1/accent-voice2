...
class TestSourceSchema(TestCase):
    ...
    def test_that_username_password_or_keyfile_is_present(self):
        ...
        key_file = {'key_file': '/var/lib/accent-auth-keys/accent-dird-accent-backend-key.yml'}
    ...
    def test_verify_certificate(self):
        cert_filename = '/usr/share/accent-certs/server.crt'
