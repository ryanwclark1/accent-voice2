...
class TestPersonalBackend(TestCase):
    ...
    def test_that_list_calls_list_on_the_search_engine(self):
        ...
        self._source.list(ids, {'user_uuid': SOME_UUID, 'token_infos': {'token': 'valid-token'}})
    ...
    def test_that_list_sets_attribute_personal_and_deletable(self):
        ...
        result = self._source.list(['1'], {'user_uuid': SOME_UUID, 'token_infos': {'token': 'valid-token'}})
    ...
    def test_that_first_match_calls_find_first_personal_contact(self):
        ...
        result = self._source.first_match('555', {'token': 'valid-token', 'user_uuid': SOME_UUID})
