...
class TestFavoritesServicePlugin(unittest.TestCase):
    ...
    @patch('accent_dird.plugins.favorites_service.plugin._FavoritesService')
    ...
    def test_that_load_injects_config_to_the_service(self, MockedFavoritesService):
        ...
        MockedFavoritesService.assert_called_once_with(self._config, self._source_manager, s.controller, ANY, s.bus)
