...
from accent.mallow.validate import Length, Range, validate_string_dict
...
class AuthConfigSchema(BaseAuthConfigSchema):
    ...
    def validate_auth_info(self, data, **kwargs):
        ...
        if key_file and username:
            raise exceptions.ValidationError('a "key_file" or a "username" and "password" must be specified')
