...
from accent_dird.database import schemas
from accent_dird.exception import NoSuchDisplay
...
class DisplayCRUD(BaseDAO):
    ...
    def create(self, tenant_uuid, name, columns, uuid=None):
        with self.new_session() as s:
            ...
            s.flush()
            return self._display_schema.dump(display)
    ...
    def edit(self, visible_tenants, display_uuid, name, columns):
        ...
        with self.new_session() as s:
            ...
            s.query(DisplayColumn).filter(DisplayColumn.display_uuid == display_uuid).delete(synchronize_session=False)
    ...
    def list_(self, visible_tenants, **list_params):
        ...
        with self.new_session() as s:
            ...
            return self._display_schema.dump(query.all(), many=True)
