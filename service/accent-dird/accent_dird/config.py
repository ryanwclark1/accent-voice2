...
_DEFAULT_CONFIG: Config = {
    ...
    'db_uri': 'postgresql://asterisk:password123@localhost/asterisk?application_name=accent-dird',
    'debug': False,
    ...
    'log_level': 'info',
    'log_filename': '/var/log/accent-dird.log',
    'rest_api': {
        'listen': '127.0.0.1',
    ...
    'services': {
        'service_discovery': {
            'template_path': '/etc/accent-dird/templates.d/',
            'services': {},
        }
    },
    'user': 'www-data',
