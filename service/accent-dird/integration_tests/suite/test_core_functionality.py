...
class TestSourceModification(BaseMultipleSourceLauncher):
    def test_source_update(self):
        ...
        assert_that(
            response,
            has_entries(results=contains(has_entries(column_values=contains('Alice', 'Alan', '1111')))),
        )
        ...
        assert_that(
            response,
            has_entries(results=contains(has_entries(column_values=contains('SUCCESS Alice', 'Alan', '1111')))),
        )
...
class TestLookupWhenASourceFails(HalfBrokenTestCase):
    ...
    def test_that_reverse_returns_a_result(self):
        ...
        assert_that(result, has_entries({'display': 'Second Lookup', 'exten': '5555555555'}))
