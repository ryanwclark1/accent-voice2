...
class TestPost(BasePersonalCRUDTestCase):
    ...
    def test_multi_tenant(self):
        ...
        assert_that(
            calling(sub_tenant_client.personal_source.create).with_args(self.valid_body, tenant_uuid=MAIN_TENANT),
...
class TestGet(BasePersonalCRUDTestCase):
    ...
    def test_get(self, accent):
        response = self.client.personal_source.get(accent['uuid'])
