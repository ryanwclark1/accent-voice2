    ...
    "value": [
        {
            ...
            "emailAddresses": [{"address": "mbros@accentquebec.onmicrosoft.com"}],
        },
        {
            "id": "another-id",
            ...
            "emailAddresses": [{"address": "lbros@accentquebec.onmicrosoft.com"}],
        },
    ]
}
...
PAGED_OFFICE365_CONTACTS_LIST = [
        ...
        "value": [
            {
                ...
                "mobilePhone": "",
                "businessPhones": ['7777777777'],
                "emailAddresses": [{"address": f"email-{i}@accentquebec.onmicrosoft.com"}],
            }
    ...
    },
    {
        "value": [
            ...
            for i in range(SECOND_PAGE_TOTAL_NUMBER_OF_CONTACTS, TOTAL_NUMBER_OF_PAGINATED_CONTACTS)
        ],
                ...
                items=contains_inanyorder(
                    has_entries(
                        ...
                        emailAddresses=contains_inanyorder(
                            has_entries(address='mbros@accentquebec.onmicrosoft.com'),
                        ),
                        mobilePhone='',
                    ...
                    has_entries(
                        ...
                        surname='Bros',
                        emailAddresses=contains_inanyorder(
                            has_entries(address='lbros@accentquebec.onmicrosoft.com'),
                        ),
                        mobilePhone='',
