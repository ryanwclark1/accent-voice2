...
from accent_test_helpers.db import DBUserClient
...
class RequestUtilMixin:
    ...
    def _update_headers(kwargs, defaults=None):
        ...
        kwargs['headers'].setdefault('Accent-Tenant', tenant)
        if defaults:
    ...
    def post(*args, **kwargs):
        kwargs = RequestUtilMixin._update_headers(kwargs, defaults={'Content-Type': 'application/json'})
