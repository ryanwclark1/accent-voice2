...
def new_half_broken_config(Session):
    ...
    config.with_profile(
        ...
        services={
            ...
            'reverse': {'sources': ['chained_broken_first_lookup', 'chained_second_lookup']},
    ...
    config.with_source(backend='chained_broken_first_lookup', name='chained_broken_first_lookup')
...
def new_ldap_config(Session):
    ...
    config.with_source(
        ...
        name='test_ldap',
        ldap_uri='ldap://slapd',
        ldap_base_dn='ou=québec,dc=accent-dird,dc=accent,dc=community',
        ldap_username='cn=admin,dc=accent-dird,dc=accent,dc=community',
        ldap_password='accentpassword',
...
def new_personal_only_config(Session):
    ...
    config.with_source(
        backend='personal',
        name='personal',
        db_uri='postgresql://accent-dird:password123@db/accent-dird',
...
def new_accent_users_config(Session):
    config = Config(Session)
    config.with_display(
        name='default_display',
        columns=[
    ...
    config.with_profile(
        ...
        display='default_display',
        services={
            'lookup': {'sources': ['accent_america']},
            'reverse': {'sources': ['accent_america']},
        },
    )
    return config


def new_accent_users_multiple_accent_config(Session):
    config = Config(Session)
    config.with_display(
        name='default_display',
        columns=[
    ...
    config.with_profile(
        ...
        display='default_display',
        services={
            'lookup': {'sources': ['accent_america', 'accent_asia', 'accent_europe']},
            'favorites': {'sources': ['accent_america', 'accent_asia', 'accent_europe']},
        },
    )
    return config
...
def new_multi_source_profile(Session):
    ...
    config.with_source(backend='csv', tenant_uuid=MAIN_TENANT, name='csv_main', file='/tmp/test.csv')
    config.with_source(backend='csv', tenant_uuid=SUB_TENANT, name='csv_sub', file='/tmp/test.csv')
    config.with_source(
        backend='personal',
        tenant_uuid=MAIN_TENANT,
        name='personal_main',
    ...
    config.with_source(backend='personal', tenant_uuid=SUB_TENANT, name='personal_sub', db_uri='db_uri')
    config.with_source(
        backend='accent',
        name='a_accent_main',
        tenant_uuid=MAIN_TENANT,
    ...
    config.with_profile(
        ...
        services={
            'lookup': {'sources': ['a_accent_main', 'personal_main']},
            'favorites': {'sources': ['a_accent_main', 'personal_main']},
    ...
    config.with_profile(
        ...
        display='sub_display',
        services={
            'lookup': {'sources': ['accent_sub', 'personal_sub']},
            'favorites': {'sources': ['accent_sub', 'personal_sub']},
