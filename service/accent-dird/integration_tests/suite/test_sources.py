...
class TestList(BaseDirdIntegrationTest):
    ...
    def test_search(self, cde, bcd, abc):
        ...
        self.assert_list_result(result, contains(self._source_to_dict('ldap', **abc)), total=3, filtered=1)

        result = self.client.sources.list(backend='csv')
        self.assert_list_result(result, contains(self._source_to_dict('csv', **cde)), total=3, filtered=1)
    ...
    def test_multi_tenant(self, bcd, abc):
        ...
        self.assert_list_result(result, contains(self._source_to_dict('ldap', **abc)), total=1, filtered=1)
    ...
    def test_pagination(self, cde, bcd, abc):
        ...
        self.assert_list_result(result, contains(self._source_to_dict('csv', **cde)), total=3, filtered=3)
