...
_DAEMONNAME = 'accent-plugind'
_DEFAULT_HTTP_PORT = 9503
_PLUGIN_DATA_DIR = 'accent'
_HOME_DIR = '/usr/lib/accent-plugind'
_DEFAULT_CONFIG = {
    'config_file': f'/etc/{_DAEMONNAME}/config.yml',
    'extra_config_files': f'/etc/{_DAEMONNAME}/conf.d/',
    'home_dir': _HOME_DIR,
    'download_dir': '/var/lib/accent-plugind/downloads',
    'extract_dir': '/var/lib/accent-plugind/tmp',
    ...
    'default_debian_package_prefix': 'accent-plugind',
    'debian_package_section': 'accent-plugind-plugin',
    'debug': False,
    'log_level': 'info',
    'log_file': f'/var/log/{_DAEMONNAME}.log',
    'user': _DAEMONNAME,
    'market': {'host': 'apps.accentvoice.io'},
    'confd': {
        'host': 'localhost',
        'port': 9486,
        'version': 1.1,
    ...
    'auth': {
        ...
        'prefix': None,
        'https': False,
        'key_file': '/var/lib/accent-auth-keys/accent-plugind-key.yml',
    },
}
