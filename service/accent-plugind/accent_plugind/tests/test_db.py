...
class TestMarketPluginUpdater(TestCase):
    def setUp(self):
        ...
        self.updater = MarketPluginUpdater(self.plugin_db, current_accent_version=CURRENT_ACCENT_VERSION)
    ...
    def test_upgradable_field_with_min_version_too_high(self):
        plugin_info = {
            'namespace': 'foobar',
            'name': 'foo',
            'versions': [{'min_accent_version': '17.13'}],
        }
    ...
    def test_upgradable_field_with_min_version_that_is_ok(self):
        plugin_info = {
            'namespace': 'foobar',
            'name': 'foo',
            'versions': [{'min_accent_version': CURRENT_ACCENT_VERSION}],
        }
    ...
    def test_upgradable_field_with_max_version_too_low(self):
        plugin_info = {
            'namespace': 'foobar',
            'name': 'foo',
            'versions': [{'max_accent_version': '17.11'}],
        }
    ...
    def test_upgradable_field_with_max_version_that_is_ok(self):
        plugin_info = {
            'namespace': 'foobar',
            'name': 'foo',
            'versions': [{'max_accent_version': CURRENT_ACCENT_VERSION}],
        }
        ...
        self.content = [
            {
                ...
                'versions': [
                    {'version': '0.1.1', 'min_accent_version': '1'},
                    {'version': '0.0.1'},
                ],
            },
            {
                ...
                'versions': [
                    {'version': '0.3.0', 'min_accent_version': '9999'},
                    {'version': '0.2.0', 'min_accent_version': '3'},
                    {'version': '0.1.1'},
                ],
            },
            {
                ...
                'versions': [
                    {'version': '0.12.0', 'min_accent_version': '2'},
                    {'version': '0.10.5', 'max_accent_version': '0'},
                ],
            },
        ]
        self.market_proxy = Mock(MarketProxy)
        self.market_proxy.get_content.return_value = self.content
        self.db = MarketDB(self.market_proxy, CURRENT_ACCENT_VERSION)
