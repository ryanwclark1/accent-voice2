...
class AgentFeatures(Handler):
    ...
    def _set_agent_interface(self) -> None:
        try:
            self._agi.set_variable('ACCENT_AGENT_INTERFACE', self._get_agent_device())
    ...
    def _set_preprocess_subroutine(self) -> None:
        ...
        self._agi.set_variable('ACCENT_AGENTPREPROCESS_SUBROUTINE', preprocess_subroutine)

    def _set_queue_call_options(self) -> None:
        queue_options = self._agi.get_variable('ACCENT_QUEUEOPTIONS')
        queue_call_options = self._extract_queue_call_options(queue_options)
        self._agi.set_variable('ACCENT_QUEUECALLOPTIONS', queue_call_options)
