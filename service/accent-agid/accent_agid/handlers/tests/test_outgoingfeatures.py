...
from accent_agid.dialplan_variables import SELECTED_CALLER_ID
...
class TestSetTrunkInfo(BaseOutgoingFeaturesTestCase):
    def test_set_trunk_info(self) -> None:
        ...
        assert_that(
            ...
            contains_exactly(
                # Trunk 0
                call('ACCENT_OUTGOING_CALLER_ID_FORMAT0', '+E164'),
                call('ACCENT_INTERFACE0', 'PJSIP'),
                call('ACCENT_TRUNKEXTEN0', '911@abc'),
                call('ACCENT_TRUNKSUFFIX0', ''),
                # Trunk 1
                call('ACCENT_OUTGOING_CALLER_ID_FORMAT1', 'national'),
                call('ACCENT_INTERFACE1', 'PJSIP'),
                call('ACCENT_TRUNKEXTEN1', '911@def'),
                call('ACCENT_TRUNKSUFFIX1', ''),
            ),
        )
...
class TestSetTenantCountry(BaseOutgoingFeaturesTestCase):
    def test_no_tenant(self) -> None:
        ...
        self._agi.set_variable.assert_called_once_with('ACCENT_TENANT_COUNTRY', '')
    ...
    def test_tenant_with_a_country(self) -> None:
        ...
        self._agi.set_variable.assert_called_once_with('ACCENT_TENANT_COUNTRY', 'CA')
...
class TestSetCallerId(BaseOutgoingFeaturesTestCase):
    @patch('accent_agid.objects.CallerID.set')
    ...
    def test_user_anonymous_and_outcall_external(self, mock_set_caller_id) -> None:
        ...
        expected_calls = [
            ...
            call('ACCENT_OUTGOING_ANONYMOUS_CALL', '1'),
        ]
    ...
    def test_user_anonymous_and_outcall_external_caller_id(
        ...
        expected_calls = [
            call('CALLERID(pres)', 'prohib'),
            call('ACCENT_OUTGOING_ANONYMOUS_CALL', '1'),
            call('_ACCENT_OUTCALL_PAI_NUMBER', '27857218'),
        ]
        self.assertEqual(self._agi.set_variable.call_args_list, expected_calls)
        self.assertFalse(mock_set_caller_id.called)
    ...
    def test_from_SIP_header_user_custom_outcall_custom(
        ...
        self._channel_variables[
            'PJSIP_HEADER(read,X-Accent-Selected-Caller-ID)'
        ] = caller_id_header
