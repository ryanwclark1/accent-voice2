...
from accent_agid.modules import check_diversion
...
class TestCheckDiversion(unittest.TestCase):
    ...
    @patch('accent_agid.modules.check_diversion.objects')
    def test_check_diversion_accent_divert_event_is_cleared(self, mock_objects):
        ...
        expected = [call('ACCENT_DIVERT_EVENT', ''), call('ACCENT_FWD_TYPE', ANY)]
