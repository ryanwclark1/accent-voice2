...
from accent_agid.modules.phone_set_feature import (
    _phone_set_busy,
    _phone_set_dnd,
...
class TestPhoneSetFeature(unittest.TestCase):
    ...
    def test_phone_set_dnd(self):
        ...
        expected_calls = [
            call('ACCENT_DNDENABLED', False),
            call('ACCENT_USERID_OWNER', self._user_id),
        ]
    ...
    def test_phone_set_incallfilter(self):
        ...
        expected_calls = [
            call('ACCENT_INCALLFILTERENABLED', True),
            call('ACCENT_USERID_OWNER', self._user_id),
        ]
        self._agi.set_variable.assert_has_calls(expected_calls)
