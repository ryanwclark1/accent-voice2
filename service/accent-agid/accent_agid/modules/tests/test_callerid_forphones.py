...
from accent_agid.modules.callerid_forphones import (
    FAKE_ACCENT_USER_UUID,
    callerid_forphones,
    is_phone_number,
)
...
class TestCallerIdForPhone(unittest.TestCase):
    ...
    @patch('accent_agid.modules.callerid_forphones.directory_profile_dao')
    ...
    def test_callerid_forphones_no_result(self, mock_dao):
        ...
        self.dird_client.directories.reverse.return_value = {'display': None}
        mock_dao.find_by_incall_id.return_value.accent_user_uuid = 'user_uuid'
