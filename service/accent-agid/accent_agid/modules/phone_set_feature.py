...
def _phone_set_callrecord(agi, cursor, args):
    ...
    agi.set_variable('ACCENT_CALLRECORDENABLED', int(calling_user.call_record_enabled))
    agi.set_variable('ACCENT_USERID_OWNER', calling_user.id)
...
def _phone_set_dnd(agi, cursor, args):
    try:
        ...
        agi.set_variable('ACCENT_DNDENABLED', int(new_value['enabled']))
        agi.set_variable('ACCENT_USERID_OWNER', user_id)
...
def _phone_set_incallfilter(agi, cursor, args):
    try:
        ...
        agi.set_variable('ACCENT_INCALLFILTERENABLED', int(new_value['enabled']))
        agi.set_variable('ACCENT_USERID_OWNER', user_id)
...
def _phone_set_vm(agi, cursor, args):
    ...
    agi.set_variable('ACCENT_VMENABLED', user.enablevoicemail)
    agi.set_variable('ACCENT_USERID_OWNER', user.id)
