...
class LDAPConfigUpdate(TenantIdentifierMixin, Command):
    ...
    def get_parser(self, *args, **kwargs):
        ...
        parser.add_argument('--bind_dn', help="DN to use to bind the service to the LDAP server")
        parser.add_argument('--bind_password', help="The password of the service account")
        parser.add_argument('user_base_dn', help='The base DN in which users are located')
        parser.add_argument('user_login_attribute', help='The attribute that identify users')
        parser.add_argument('user_email_attribute', help='The email attribute in ldap schema')
    ...
    def take_action(self, parsed_args):
        ...
        config_ldap = self.app.client.ldap_config.update(params, tenant_uuid=params.get('tenant_uuid'))
...
class LDAPConfigShow(TenantIdentifierMixin, Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.stdout.write(json.dumps(config_ldap, indent=True, sort_keys=True) + '\n')
