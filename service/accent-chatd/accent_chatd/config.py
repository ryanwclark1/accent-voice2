...
_DEFAULT_CONFIG = {
    'config_file': '/etc/accent-chatd/config.yml',
    'debug': False,
    'extra_config_files': '/etc/accent-chatd/conf.d',
    'log_file': '/var/log/accent-chatd.log',
    'log_level': 'info',
    'user': 'accent-chatd',
    'rest_api': {
        'listen': '127.0.0.1',
    ...
    'db_uri': 'postgresql://asterisk:password123@localhost/asterisk?application_name=accent-chatd',
    'auth': {
        'host': 'localhost',
        'port': 9497,
        'prefix': None,
        'https': False,
        'key_file': '/var/lib/accent-auth-keys/accent-chatd-key.yml',
    },
    'bus': {
        'username': 'guest',
        'password': 'guest',
