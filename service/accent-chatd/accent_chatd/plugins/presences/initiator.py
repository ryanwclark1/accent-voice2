...
from accent_chatd.database.helpers import session_scope
from accent_chatd.database.models import (
    Channel,
    Endpoint,
    Line,
    RefreshToken,
...
from accent_chatd.exceptions import (
    ...
    def initiate_channels(self, events):
        with session_scope():
            ...
            for event in events:
                ...
                if event['ChanVariable'].get('ACCENT_ON_HOLD') == '1':
                    state = 'holding'
