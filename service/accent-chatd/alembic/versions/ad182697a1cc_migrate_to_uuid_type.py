...
def upgrade():
    ...
    convert_column_to_uuid('chatd_room_user', 'accent_uuid')
    ...
    convert_column_to_uuid('chatd_room_message', 'accent_uuid')
...
def downgrade():
    ...
    convert_column_to_string('chatd_room_user', 'accent_uuid')
    ...
    convert_column_to_string('chatd_room_message', 'accent_uuid')
