...
class SwitchboardsStasis:
    ...
    def unqueue(self, channel, event):
        switchboard_uuid = channel.json['channelvars']['ACCENT_SWITCHBOARD_QUEUE']
        tenant_uuid = channel.json['channelvars']['ACCENT_TENANT_UUID']
    ...
    def unhold(self, channel, event):
        switchboard_uuid = channel.json['channelvars']['ACCENT_SWITCHBOARD_HOLD']
        tenant_uuid = channel.json['channelvars']['ACCENT_TENANT_UUID']
