...
from accent_calld.plugin_helpers.ari_ import AUTO_ANSWER_VARIABLES, Channel
from accent_calld.plugin_helpers.confd import User
from accent_calld.plugin_helpers.exceptions import InvalidUserUUID
...
class SwitchboardsService:
    ...
    def new_queued_call(self, tenant_uuid, switchboard_uuid, channel_id):
        ...
        channel.setChannelVar(variable='ACCENT_SWITCHBOARD_QUEUE', value=switchboard_uuid)
        channel.setChannelVar(variable='ACCENT_TENANT_UUID', value=tenant_uuid)
        channel.answer()
    ...
    def hold_call(self, tenant_uuid, switchboard_uuid, call_id):
        ...
        with self._switchboards_lock.acquired(switchboard_uuid, call_id):
            ...
            channel_to_hold.setChannelVar(
                variable='ACCENT_SWITCHBOARD_HOLD', value=switchboard_uuid
            )
            channel_to_hold.setChannelVar(
                variable='ACCENT_TENANT_UUID', value=tenant_uuid
            )
