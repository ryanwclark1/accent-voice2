...
class CallsStasis:
    def __init__(
        self, ari, collectd, bus_publisher, services, notifier, accent_uuid, amid_client
    ):
        self.ari = ari.client
        self._core_ari = ari
    ...
    def _stasis_start_blind_transfer_channel(self, event_objects, event):
        ...
        tenant_uuid = transfer_initiator_channel_dict['channelvars']['ACCENT_TENANT_UUID']
        transfer_recipient_channel.setChannelVar(
            variable='__ACCENT_TENANT_UUID', value=tenant_uuid
        )
