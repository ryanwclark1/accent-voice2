...
from accent_calld.bus import CoreBusConsumer as BusConsumer
...
class ParkingService:
    ...
    def _park_channel(
        ...
        try:
            ...
            raise AccentAmidError(self._amid, e)
    ...
    def count_parked_calls(self, tenant_uuid: str, parking_id: int) -> int:
        ...
        if complete.get('Event') != 'ParkedCallsComplete':
            raise AccentAmidError(self._amid, 'missing ParkedCallsComplete message')
