...
class IntegrationTest(AssetLaunchingTestCase):
    ...
    def setup_tokens(cls):
        ...
        calld_credential = MockCredentials('accent-calld-service', 'opensesame')
        amid_credential = MockCredentials('accent-amid-service', 'opensesame')
        ...
        cls.auth.set_tenants(
            {
                ...
                'name': 'accent-calld-service-tenant',
