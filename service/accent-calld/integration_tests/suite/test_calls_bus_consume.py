...
from .helpers.constants import ACCENT_UUID, SOME_STASIS_APP, VALID_TENANT
        ...
        self.ari.set_channels(
            MockChannel(
                ...
                channelvars={
                    ...
                    'ACCENT_ANSWER_TIME': '2022-03-08T03:49:00+00:00',
                },
            )
        )
        self.ari.set_channel_variable(
            {
                call_id: {
                    'ACCENT_TENANT_UUID': VALID_TENANT,
                    'ACCENT_CALL_DIRECTION': 'outbound',
                },
            }
        )
    ...
    def test_when_channel_answered_then_bus_event(self):
        ...
        self.ari.set_channels(
            MockChannel(
                ...
                state='Up',
                channelvars={
                    'ACCENT_ANSWER_TIME': '2022-03-08T03:48:00+00:00',
                },
            )
        )
        self.ari.set_channel_variable(
            {
                call_id: {
                    'ACCENT_TENANT_UUID': VALID_TENANT,
                    'ACCENT_CALL_DIRECTION': 'internal',
                },
            }
        )
