...
from accent_call_logd.database.models import CallLog, CallLogParticipant
from accent_call_logd.exceptions import InvalidCallLogException
from accent_call_logd.extension_filter import DEFAULT_HIDDEN_EXTENSIONS, ExtensionFilter
from accent_call_logd.utils import find
...
class RawCallLog:
    def __init__(self):
        ...
        self.interpret_caller_accent_user_fwd: bool = True
