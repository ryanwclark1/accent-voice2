...
from accent_call_logd.exceptions import CELInterpretationError
...
from ..cel_interpretor import (
    ...
    _parse_accent_originate_all_lines_extra,
    bridge_info,
    extract_cel_extra,
...
class TestExtractUserMissedCallVariables(TestCase):
    def setUp(self):
        self.accent_tenant_uuid = '2c34c282-433e-4bb8-8d56-fec14ff7e1e9'
    ...
    def test_uriencoded_field(self):
        ...
        for separator in self.valid_separators:
            extra_string = separator.join(
                [
                    f'accent_tenant_uuid: {self.accent_tenant_uuid}',
...
class TestParseOriginateAllLinesExtra:
    def test_valid_payloads(self):
        ...
        for extra in valid_extras:
            info = _parse_accent_originate_all_lines_extra(extra)
    ...
    def test_invalid_payload(self):
        ...
        for extra in invalid_extras:
            with raises(CELInterpretationError):
                _parse_accent_originate_all_lines_extra(extra)
...
class TestCallerCELInterpretor(TestCase):
    def setUp(self):
        ...
        self.call = create_autospec(
            RawCallLog(),
            instance=True,
            interpret_caller_accent_user_fwd=True,
    ...
    def test_interpret_accent_user_fwd_regexp(self):
        cel = Mock(
            eventtype='ACCENT_USER_FWD',
            extra='{"extra":"NUM:100,CONTEXT:internal,NAME:Bob Marley"}',
        )

        result = self.caller_cel_interpretor.interpret_accent_user_fwd(cel, self.call)
    ...
    def test_interpret_accent_user_fwd_regexp_with_space(self):
        cel = Mock(
            eventtype='ACCENT_USER_FWD',
            extra='{"extra":" NUM: 100 , CONTEXT: internal , NAME: Bob Marley "}',
        )
    ...
    def test_interpret_accent_user_fwd_regexp_with_value_before(self):
        cel = Mock(
            eventtype='ACCENT_USER_FWD',
    ...
    def test_interpret_accent_user_fwd_regexp_with_value_after(self):
        cel = Mock(
            eventtype='ACCENT_USER_FWD',
    ...
    def test_interpret_accent_internal_call_has_destination_details(self):
        cel = Mock(
            eventtype='ACCENT_CALL_LOG_DESTINATION',
            extra='{"extra":"type: user,uuid: c3f297bd-93e1-46f6-a309-79b320acb7fb,'
            'name: Willy Wonka"}',
        )

        result = self.caller_cel_interpretor.interpret_accent_call_log_destination(
            cel, self.call
        )
    ...
    def test_interpret_accent_incoming_call_has_destination_details(self):
        cel = Mock(
            eventtype='ACCENT_CALL_LOG_DESTINATION',
    ...
    def test_interpret_accent_meeting_has_destination_details(self):
        cel = Mock(
            eventtype='ACCENT_CALL_LOG_DESTINATION',
    ...
    def test_interpret_accent_conference_has_destination_details(self):
        cel = Mock(
            eventtype='ACCENT_CALL_LOG_DESTINATION',
