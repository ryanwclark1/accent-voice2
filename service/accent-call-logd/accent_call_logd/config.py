...
_PID_DIR = '/run/accent-call-logd'

DEFAULT_CONFIG = {
    'logfile': '/var/log/accent-call-logd.log',
    'log_level': 'info',
    'config_file': '/etc/accent-call-logd/config.yml',
    'extra_config_files': '/etc/accent-call-logd/conf.d',
    'debug': False,
    'user': 'accent-call-logd',
    'db_upgrade_on_startup': False,
    'db_uri': (
        'postgresql://asterisk:password123@localhost/asterisk?'
        'application_name=accent-call-logd'
    ),
    'cel_db_uri': (
        'postgresql://asterisk:password123@localhost/asterisk?'
        'application_name=accent-call-logd'
    ),
    'email_export_body_template': '/var/lib/accent-call-logd/templates/email_export_body.j2',
    'email_export_token_expiration': 48 * 3600,  # 48 hours
    'email_export_from_name': 'Accent',
    'email_export_from_address': 'no-reply@accentvoice.io',
    'email_export_subject': 'Your export is ready',
    'exports': {
        'directory': '/var/lib/accent-call-logd/exports',
        'key_file': '/var/lib/accent-auth-keys/accent-call-logd-export-key.yml',
    },
    'bus': {
        'username': 'guest',
        'password': 'guest',
    ...
    'auth': {
        ...
        'prefix': None,
        'https': False,
        'key_file': '/var/lib/accent-auth-keys/accent-call-logd-key.yml',
