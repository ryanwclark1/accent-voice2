# Copyright 2012-2023 Accent Communications
...
from accent_stat import config, core

PIDFILENAME = '/run/accent-stat.pid'
...
def main():
    ...
    with pidfile_context(PIDFILENAME):
        parser = argparse.ArgumentParser(description='Accent statistics generator')
