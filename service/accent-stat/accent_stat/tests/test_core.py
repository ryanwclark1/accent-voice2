# Copyright 2013-2023 Accent Communications

import datetime
import unittest
from unittest.mock import ANY, patch, sentinel

from accent_stat import core
from accent_stat.core import _ERASE_TIME_WHEN_STARTING
...
class TestCore(unittest.TestCase):
    ...
    @patch('accent_dao.stat_queue_periodic_dao.get_most_recent_time')
    ...
    @patch('accent_dao.stat_queue_periodic_dao.get_most_recent_time')
    @patch('accent_dao.queue_log_dao.get_first_time')
    ...
    @patch('accent_dao.stat_agent_dao.clean_table')
    @patch('accent_dao.stat_agent_periodic_dao.clean_table')
    @patch('accent_dao.stat_call_on_queue_dao.clean_table')
    @patch('accent_dao.stat_queue_dao.clean_table')
    @patch('accent_dao.stat_queue_periodic_dao.clean_table')
    def test_clean_db(
        self,
    ...
    @patch('accent_dao.queue_log_dao.get_queue_names_in_range')
    @patch('accent_dao.stat_queue_dao.insert_if_missing')
    ...
    @patch('accent_dao.stat_agent_dao.insert_missing_agents')
