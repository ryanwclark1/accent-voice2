# Copyright 2013-2024 Accent Communications
...
class TestQueue(unittest.TestCase):
    ...
    @patch('accent_dao.queue_log_dao.get_queue_abandoned_call')
    @patch('accent_dao.stat_call_on_queue_dao.add_abandoned_call')
    ...
    @patch('accent_dao.queue_log_dao.get_queue_timeout_call')
    @patch('accent_dao.stat_call_on_queue_dao.add_timeout_call')
    ...
    @patch('accent_stat.queue.fill_abandoned_call')
    @patch('accent_stat.queue.fill_timeout_call')
    ...
    @patch('accent_dao.stat_dao.fill_simple_calls')
    @patch('accent_dao.stat_dao.fill_answered_calls')
    @patch('accent_dao.stat_dao.fill_leaveempty_calls')
    ...
    @patch('accent_dao.stat_call_on_queue_dao.get_periodic_stats_hour')
    @patch('accent_dao.stat_queue_periodic_dao.insert_stats')
    ...
    @patch('accent_dao.stat_call_on_queue_dao.remove_callids')
    @patch('accent_dao.stat_call_on_queue_dao.find_all_callid_between_date')
    @patch('accent_dao.stat_queue_periodic_dao.remove_after')
