...
class TestPJSIPConfGenerator(unittest.TestCase):
    ...
    def test_generate_transports(self):
        output = StringIO()
        with patch('accent_confgend.plugins.pjsip_conf.transport_dao') as dao:
    ...
    def test_generate_users(self):
        ...
        with patch('accent_confgend.plugins.pjsip_conf.asterisk_conf_dao') as dao:
    ...
    def test_generate_trunks(self):
        ...
        with patch('accent_confgend.plugins.pjsip_conf.asterisk_conf_dao') as dao:
            dao.find_sip_trunk_settings.return_value = [
                {
                    ...
                    'registration_section_options': [
                        ...
                        [
                            'outbound_auth',
                            'auth_reg_dev_370@accent-dev-gateway.lan.accentvoice.io',
                        ],
                    ],
            ...
            assert_config_equal(
                ...
                type = registration
                expiration = 120
                outbound_auth = auth_reg_dev_370@accent-dev-gateway.lan.accentvoice.io
                '''.format(
