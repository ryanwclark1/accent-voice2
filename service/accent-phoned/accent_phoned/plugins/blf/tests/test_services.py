...
class TestServices(unittest.TestCase):
    def setUp(self):
        ...
        accent_helpers.fkey_extension = MagicMock()

    def test_dnd_enable(self):
        accent_helpers.fkey_extension.return_value = '*735123***225'
    ...
    def test_incallfilter_enable(self):
        accent_helpers.fkey_extension.return_value = '*735123***227'
    ...
    def test_forward_unconditional_enable(self):
        accent_helpers.fkey_extension.side_effect = [
            '*735123***221*1002',
            '*735123***221',
        ]
