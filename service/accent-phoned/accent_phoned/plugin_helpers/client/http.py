...
from .exceptions import AccentAuthConnectionError, AccentDirdConnectionError, NoSuchUser
...
class ClientMenu(AuthResource):
    ...
    def get(self, profile):
        ...
        user_uuid = args['accent_user_uuid']
...
class ClientLookup(AuthResource):
    ...
    def _lookup_and_render_template(self, user_uuid, profile, term, limit, offset):
        ...
        try:
            ...
            raise AccentDirdConnectionError()
    ...
    def _get_user_tenant_uuid(self, user_uuid):
        try:
            ...
            raise AccentAuthConnectionError()
...
class _PhoneResultFormatter:
    ...
    # NOTE: this should be handled by dird
