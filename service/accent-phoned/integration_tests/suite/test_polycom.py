                    ...
                    <html>
                      ...
                      <body>
                        <form action="https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/polycom" method="get" accept-charset="utf-8">
                          ...
                          <input type="hidden" name="accent_user_uuid" value="{USER_1_UUID}" />
                ...
                dedent(
                    ...
                    <html>
                      ...
                      <body>
                        <ol>
                    <li><a href="tel://0033123456789">Test User1</a><br /></li>
                    <li>[<a href="https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/polycom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=1" title="Next">Next Page</a>]<br /></li>
                    </ol>
                      </body>
                    </html>"""
                )
            ...
            equal_to(
                dedent(
                    ...
                    <html>
                      ...
                      <body>
                        <ol>
                    <li>[<a href="https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/polycom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=0" title="Previous">Previous Page</a>]<br /></li>
                    <li><a href="tel://5555555555">Test User1 (mobile)</a><br /></li>
                    <li>[<a href="https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/polycom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=2" title="Next">Next Page</a>]<br /></li>
                    </ol>
                      </body>
                    </html>"""
                )
            ...
            equal_to(
                dedent(
                    ...
                    <html>
                      ...
                      <body>
                        <ol>
                    <li>[<a href="https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/polycom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=1" title="Previous">Previous Page</a>]<br /></li>
                    <li><a href="tel://1000">Test User2</a><br /></li>
                    </ol>
                      </body>
                    </html>"""
