...
class TestSnom(BasePhonedIntegrationTest):
    ...
    def test_that_input_return_no_error_when_query_ssl(self):
        ...
        <SnomIPPhoneInput>
         ...
         <InputItem>
          ...
          <QueryStringParam>accent_user_uuid={USER_1_UUID}&amp;term</QueryStringParam>
          <DefaultValue />
    ...
    def test_that_lookup_with_limit_one_shows_next_page_link(self):
        ...
        <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/snom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=1</URL>
        <Name>F4</Name>
        </SoftKeyItem>
        </SnomIPPhoneMenu>"""
                )
    ...
    def test_that_lookup_with_limit_one_offset_one_shows_previous_and_next_page_links(
        ...
        <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/snom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=0</URL>
        <Name>F2</Name>
        </SoftKeyItem>
        <SoftKeyItem>
        <Label>NextPage</Label>
        <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/snom?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=2</URL>
        <Name>F4</Name>
        </SoftKeyItem>
        </SnomIPPhoneMenu>"""
                )
