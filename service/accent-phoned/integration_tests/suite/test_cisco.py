        ...
        assert_that(
            ...
            equal_to(
                dedent(
                    ...
                    <CiscoIPPhoneMenu>
                     <MenuItem>
                      <Name>Accent Directory</Name>
                      <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/input/{DEFAULT_PROFILE}/cisco?accent_user_uuid={USER_1_UUID}</URL>
                     </MenuItem>
                    </CiscoIPPhoneMenu>"""
                )
            ),
            ...
            equal_to(
                dedent(
                    ...
                    <CiscoIPPhoneInput>
                     ...
                     <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/cisco?accent_user_uuid={USER_1_UUID}</URL>
                     <InputItem>
        ...
        assert_that(
            ...
            equal_to(
                dedent(
                    ...
                    <SoftKeyItem>
                    <Name>NextPage</Name>
                    <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/cisco?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=1</URL>
                    <Position>4</Position>
                    </SoftKeyItem>
                    </CiscoIPPhoneDirectory>"""
                )
        ...
        assert_that(
            ...
            equal_to(
                dedent(
                    ...
                    <SoftKeyItem>
                    <Name>PrevPage</Name>
                    <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/cisco?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=0</URL>
                    <Position>2</Position>
                    </SoftKeyItem>
                    <SoftKeyItem>
                    <Name>Exit</Name>
                    ...
                    <SoftKeyItem>
                    <Name>NextPage</Name>
                    <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/cisco?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=2</URL>
                    <Position>4</Position>
                    </SoftKeyItem>
                    </CiscoIPPhoneDirectory>"""
                )
