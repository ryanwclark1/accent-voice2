...
class TestFanvil(BasePhonedIntegrationTest):
            ...
            equal_to(
                dedent(
                    ...
                    <FanvilIPPhoneInputScreen>
                     ...
                     <URL>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/fanvil?accent_user_uuid={USER_1_UUID}</URL>
                     <InputField>
                      <Prompt>Name or number</Prompt>
        ...
        assert_that(
            ...
            equal_to(
                dedent(
                    ...
                    <SoftKey>
                    <Name>NextPage</Name>
                    <URI>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/fanvil?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=1</URI>
                    </SoftKey>
                    </FanvilIPPhoneDirectory>"""
                )
            ),
        ...
        assert_that(
            ...
            equal_to(
                dedent(
                    ...
                    <SoftKey>
                    <Name>PrevPage</Name>
                    <URI>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/fanvil?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=0</URI>
                    </SoftKey>
                    <SoftKey>
                    <Name>Exit</Name>
                    <URI>SoftKey:Exit</URI>
                    ...
                    <SoftKey>
                    <Name>NextPage</Name>
                    <URI>https://127.0.0.1:{self.service_port(9499, 'phoned')}/0.1/directories/lookup/{DEFAULT_PROFILE}/fanvil?accent_user_uuid={USER_1_UUID}&amp;term={VALID_TERM}&amp;limit=1&amp;offset=2</URI>
                    </SoftKey>
                    </FanvilIPPhoneDirectory>"""
                )
            ),
    ...
    def test_that_v2_lookup_return_error_when_no_accent_user_uuid(self):
        response = self.get_lookup_result(
    ...
    def test_that_v2_lookup_return_error_when_invalid_user_uuid(self):
        response = self.get_lookup_result(
            vendor=VENDOR_V2, profile='a', accent_user_uuid='invalid', term=VALID_TERM
        )
        assert_that(response.status_code, equal_to(404))
