...
@target('1.0.27.2', 'accent-grandstream-1.0.27.2')
...
@target('1.0.3.27', 'accent-grandstream-1.0.3.27')
...
@target('1.0.3.2x-android', 'accent-grandstream-1.0.3.2x-android')
...
@target('1.0.5.48', 'accent-grandstream-1.0.5.48')
...
@target('1.0.7.13', 'accent-grandstream-1.0.7.13')
...
@target('1.0.8.6', 'accent-grandstream-1.0.8.6')
...
@target('1.0.11.85', 'accent-grandstream-1.0.11.85')
...
@target('1.0.8.9', 'accent-grandstream-1.0.8.9')
...
@target('1.2.5.3', 'accent-grandstream-1.2.5.3')
...
@target('1.0.11.79', 'accent-grandstream-1.0.11.79')
