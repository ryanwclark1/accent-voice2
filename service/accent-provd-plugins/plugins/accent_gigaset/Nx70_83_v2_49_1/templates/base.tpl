...
{%- for provider in XX_voip_providers %}
        ...
        <param name="SipProvider.{{ provider['id'] }}.Name" value="Accent{{ provider['id'] }}"/>
...
{%- endfor %}
        ...
        <param name="XMLDir.1.ProviderName" value="Accent"/>
        <param name="XMLDir.1.ServerURL" value="{{ XX_accent_phonebook_url }}"/>
