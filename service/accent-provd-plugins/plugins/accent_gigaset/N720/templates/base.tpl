...
<ProviderFrame xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="N720_general.xsd">
    ...
    {%- if XX_accent_phonebook_url %}
        ...
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[0].aucProviderName[%]" class="symb_item" value='"AccentPBX"'/>
        ...
        <SYMB_ITEM ID="BS_XML_Netdirs.astNetdirProvider[0].aucServerURL[%]" class="symb_item" value='"{{ XX_accent_phonebook_url }}"'/>
    ...
    <!-- Genaral settings for 100 VoIP accounts-->
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucSIP_PROVIDER_NAME[%]" class="symb_item" value='"AccentPBX"'/>
        {%- if sip_proxy_ip %}
        ...
        <SYMB_ITEM ID="BS_VOIP_Data.astVoipProviders[0].aucCURRENT_PROFILE_NAME[0]" class="symb_item" value='"accentpbx"'/>
