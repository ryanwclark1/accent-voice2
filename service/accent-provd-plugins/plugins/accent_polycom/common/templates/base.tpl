...
mb.main.home="{{ XX_accent_phonebook_url|e }}"

softkey.1.enable="1"
softkey.1.action="{{ XX_accent_phonebook_url|e }}"
...
apps.push.username="accent_switchboard"
apps.push.password="accent_switchboard"
