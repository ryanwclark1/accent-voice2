...
<sysConf>
    ...
    <sip>
        ...
        <STUNServer>stun.accentvoice.io</STUNServer>
        ...
        <line index="{{ line_no }}">
            ...
            <UserAgent>accent-fanvil</UserAgent>
            <PRACK>0</PRACK>
            <KeepAUTH>0</KeepAUTH>
...
{% if XX_accent_phonebook_url_v2 -%}
       <xmlContact index="1">
            <Name>{{ XX_directory|d('Directory') }}</Name>
            <Addr>{{ XX_accent_phonebook_url_v2 }}</Addr>
            <UserName></UserName>
            <PassWd></PassWd>
            <Sipline>-1</Sipline>
            <BindLine>-1</BindLine>
...
{%- endif %}
    ...
    <cti>
        {% if XX_accent_phoned_user_service_dnd_enabled_url -%}
        <DNDOnUrl>{{ XX_accent_phoned_user_service_dnd_enabled_url }}</DNDOnUrl>
        {% endif -%}
        {% if XX_accent_phoned_user_service_dnd_disabled_url -%}
        <DNDOffUrl>{{ XX_accent_phoned_user_service_dnd_disabled_url }}</DNDOffUrl>
        {% endif -%}
    </cti>
    <web>
