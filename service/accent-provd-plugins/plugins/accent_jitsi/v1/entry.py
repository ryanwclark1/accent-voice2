...
try:
    ...
    from accent_provd.plugins import StandardPlugin, TemplatePluginHelper
    from accent_provd.servers.http_site import Request
    from accent_provd.util import is_normed_uuid, norm_uuid
except ImportError:
...
logger = logging.getLogger('plugin.accent-jitsi')
