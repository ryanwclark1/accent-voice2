...
class TestInfoExtraction:
    ...
    @patch('plugins.accent_yealink.v84.common.defer')
    ...
    @patch('plugins.accent_yealink.v84.common.logger')
...
class TestPlugin:
    @patch('plugins.accent_yealink.v84.common.FetchfwPluginHelper')
    ...
    @patch('plugins.accent_yealink.v84.common.synchronize')
    ...
    @patch('plugins.accent_yealink.v84.common.plugins')
    def test_phonebook_url(self, provd_plugins, v84_plugin):
        raw_config = {'config_version': 1}
        v84_plugin._add_accent_phonebook_url(raw_config)
