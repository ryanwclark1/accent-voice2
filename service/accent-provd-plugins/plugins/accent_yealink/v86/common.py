...
logger = logging.getLogger('plugin.accent-yealink')

KNOWN_MAC_PREFIXES = (
    b'001565',
    b'e434d7',
    b'805ec0',
    b'805e0c',  # NOTE: not a mistake
    b'249ad8',
    b'44dbd2',
)
...
class BaseYealinkPlugin(StandardPlugin):
    ...
    def _add_accent_phoned_user_service_url(self, raw_config, service):
        if hasattr(plugins, 'add_accent_phoned_user_service_url'):
            plugins.add_accent_phoned_user_service_url(raw_config, 'yealink', service)
