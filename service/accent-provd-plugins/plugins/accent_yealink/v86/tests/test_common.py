...
class TestInfoExtraction:
    ...
    @patch('plugins.accent_yealink.v86.common.defer')
    ...
    @patch('plugins.accent_yealink.v86.common.logger')
...
class TestPlugin:
    @patch('plugins.accent_yealink.v86.common.FetchfwPluginHelper')
    ...
    @patch('plugins.accent_yealink.v86.common.synchronize')
    ...
    @patch('plugins.accent_yealink.v86.common.plugins')
    def test_phonebook_url(self, provd_plugins, v86_plugin):
        raw_config = {'config_version': 1}
        v86_plugin._add_accent_phonebook_url(raw_config)
