...
from accent_provd.devices.pgasso import DeviceSupport
from accent_provd.tzinform import TimezoneNotFoundError
...
class TestInfoExtraction:
    ...
    @patch('plugins.accent_yealink.v85.common.defer')
    ...
    @patch('plugins.accent_yealink.v85.common.logger')
...
class TestPlugin:
    @patch('plugins.accent_yealink.v85.common.FetchfwPluginHelper')
    ...
    @patch('plugins.accent_yealink.v85.common.synchronize')
    ...
    @patch('plugins.accent_yealink.v85.common.plugins')
    def test_phonebook_url(self, provd_plugins, v85_plugin):
        raw_config = {'config_version': 1}
        v85_plugin._add_accent_phonebook_url(raw_config)
        provd_plugins.add_accent_phonebook_url.assert_called_with(
            raw_config,
            'yealink',
            entry_point='lookup',
