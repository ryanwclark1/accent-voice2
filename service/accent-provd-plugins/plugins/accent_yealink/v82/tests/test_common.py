...
class TestInfoExtraction:
    ...
    @patch('plugins.accent_yealink.v82.common.defer')
    ...
    @patch('plugins.accent_yealink.v82.common.logger')
...
class TestPlugin:
    @patch('plugins.accent_yealink.v82.common.FetchfwPluginHelper')
    ...
    @patch('plugins.accent_yealink.v82.common.synchronize')
    ...
    @patch('plugins.accent_yealink.v82.common.plugins')
    def test_phonebook_url(self, provd_plugins, v82_plugin):
        raw_config = {'config_version': 1}
        v82_plugin._add_accent_phonebook_url(raw_config)
