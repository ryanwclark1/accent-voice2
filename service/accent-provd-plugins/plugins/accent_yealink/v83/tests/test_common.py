...
class TestInfoExtraction:
    ...
    @patch('plugins.accent_yealink.v83.common.defer')
    ...
    @patch('plugins.accent_yealink.v83.common.logger')
...
class TestPlugin:
    @patch('plugins.accent_yealink.v83.common.FetchfwPluginHelper')
    ...
    @patch('plugins.accent_yealink.v83.common.synchronize')
    ...
    @patch('plugins.accent_yealink.v83.common.plugins')
    def test_phonebook_url(self, provd_plugins, v83_plugin):
        raw_config = {'config_version': 1}
        v83_plugin._add_accent_phonebook_url(raw_config)
