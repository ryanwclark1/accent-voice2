...
remote_phonebook.data.1.url = {{ XX_accent_phonebook_url }}
remote_phonebook.data.1.name = Accent
{% else -%}
...
action_url.dnd_on = {{ XX_accent_phoned_user_service_dnd_enabled_url }}
{% endif -%}
{% if XX_accent_phoned_user_service_dnd_disabled_url -%}
action_url.dnd_off = {{ XX_accent_phoned_user_service_dnd_disabled_url }}
{% endif -%}
