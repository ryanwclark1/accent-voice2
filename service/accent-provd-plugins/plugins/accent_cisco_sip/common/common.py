...
logger = logging.getLogger('plugin.accent-cisco-sip')
...
class BaseCiscoSipPlugin(StandardPlugin):
    ...
    def __init__(self, app, plugin_dir, gen_cfg, spec_cfg):
        ...
        # general http_port setting of accent-provd ?
        # At the moment, http_port 6970 must be set in /etc/accent-provd/config.yml
    ...
    def synchronize(self, device, raw_config):
        ...
        except TypeError:  # accent-provd not up to date for extra_vars
            return defer.fail(
                Exception('operation not supported, please update your accent-provd')
            )
