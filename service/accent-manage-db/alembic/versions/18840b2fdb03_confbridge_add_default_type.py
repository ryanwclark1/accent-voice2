...
def upgrade():
    ...
    section_id = _rename_asterisk_file_section(file_id, 'default_bridge', 'accent_default_bridge')
    _insert_asterisk_file_variable(section_id, 'type', 'bridge')

    section_id = _rename_asterisk_file_section(file_id, 'default_user', 'accent_default_user')
...
def downgrade():
    ...
    section_id = _rename_asterisk_file_section(file_id, 'accent_default_bridge', 'default_bridge')
    _remove_asterisk_file_variable(section_id, 'type', 'bridge')

    section_id = _rename_asterisk_file_section(file_id, 'accent_default_user', 'default_user')
