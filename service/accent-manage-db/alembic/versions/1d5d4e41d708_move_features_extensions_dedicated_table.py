...
def upgrade():
    ...
    # move extensions having context=accent-features from 'extensions' table into 'feature_extension' table
    op.execute('''
    ...
    op.execute("DELETE FROM extensions where context = 'accent-features';")
...
def downgrade():
    ...
    INSERT INTO extensions (commented, context, exten, type, typeval)
      SELECT
        ...
        TEXT 'accent-features' as context,
        exten,
