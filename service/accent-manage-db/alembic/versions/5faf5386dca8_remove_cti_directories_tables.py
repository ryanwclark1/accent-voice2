...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column('description', sa.Text),
        sa.Column('accent_username', sa.Text),
        sa.Column('accent_password', sa.Text),
        sa.Column('accent_verify_certificate', sa.Boolean, nullable=False, default=False),
        sa.Column('accent_custom_ca_path', sa.Text),
