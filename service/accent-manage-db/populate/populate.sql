...
INSERT INTO "features" VALUES (DEFAULT,1,0,0,'features.conf','applicationmap','togglerecord','*3,self,AGI(agi://${ACCENT_AGID_IP}/call_recording)');
...
INSERT INTO "asterisk_file_section" (name, priority, asterisk_file_id) VALUES ('accent_default_bridge', NULL, (SELECT id FROM asterisk_file WHERE name = 'confbridge.conf'));
INSERT INTO "asterisk_file_variable" (key, value, asterisk_file_section_id) VALUES ('type', 'bridge', (SELECT id FROM asterisk_file_section
                                                                                                       WHERE name = 'accent_default_bridge'
                                                                                                       AND asterisk_file_id = (SELECT id FROM asterisk_file WHERE name = 'confbridge.conf')));
INSERT INTO "asterisk_file_section" (name, priority, asterisk_file_id) VALUES ('accent_default_user', NULL, (SELECT id FROM asterisk_file WHERE name = 'confbridge.conf'));
INSERT INTO "asterisk_file_variable" (key, value, asterisk_file_section_id) VALUES ('type', 'user', (SELECT id FROM asterisk_file_section
                                                                                                     WHERE name = 'accent_default_user'
                                                                                                     AND asterisk_file_id = (SELECT id FROM asterisk_file WHERE name = 'confbridge.conf')));
...
INSERT INTO "asterisk_file_variable" (key, value, asterisk_file_section_id) VALUES
  ('user_agent', 'Accent PBX', (SELECT id FROM asterisk_file_section WHERE name = 'global' AND asterisk_file_id = (SELECT id FROM asterisk_file WHERE name = 'pjsip.conf'))),
...
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','serveremail','accent');
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','charset','UTF-8');
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','fromstring','Accent PBX');
...
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','emailsubject','Message From Accent');
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','emailbody','Hello ${VM_NAME},\n\nYou have received a message that is ${VM_DUR} minute(s) long. Currently, you have ${VM_MSGNUM} unread message(s) in your voicemail at ${VM_MAILBOX}.\n\nThe last message was sent by ${VM_CALLERID} on ${VM_DATE}. If you wish, you can listen to it or check it by dialing *98 on your phone.\n\nThank you.\n\n-- Accent Voicemail --');
INSERT INTO "staticvoicemail" VALUES (DEFAULT,0,0,0,'voicemail.conf','general','pagerfromstring','Accent PBX');
...
INSERT INTO "mail" VALUES (DEFAULT,'','example.accentvoice.io','','','');
...
INSERT INTO "infos" (uuid, accent_version, live_reload_enabled, timezone, configured) VALUES ('populate-uuid', '24.16', 'True', 'America/Chicago', 'False');
