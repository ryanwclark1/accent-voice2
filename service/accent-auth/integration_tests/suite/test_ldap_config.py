...
class TestLDAPConfigAuth(base.APIIntegrationTest):
    ...
    def test_put_new_config(self):
        body = {
            ...
            'protocol_version': 3,
            'protocol_security': None,
            'bind_dn': 'uid=admin,ou=people,dc=accentvoice,dc=io',
            'bind_password': 'super-secret',
            'user_base_dn': 'ou=people,dc=accentvoice,dc=io',
    ...
    def test_put_config_when_already_exists(self, _):
        new_body = {
            ...
            'bind_dn': 'uid=root,ou=people,dc=accentvoice,dc=io',
            'bind_password': 'not-so-super-secret',
            'user_base_dn': 'ou=genses,dc=accentvoice,dc=io',
