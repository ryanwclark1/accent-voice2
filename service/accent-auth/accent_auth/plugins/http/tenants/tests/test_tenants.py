...
from accent_auth.config import _DEFAULT_CONFIG
from accent_auth.tests.test_http import HTTPAppTestCase
...
class TestTenantPost(HTTPAppTestCase):
    ...
    @patch('accent_auth.plugins.http.tenants.http.TenantDetector')
    ...
    def test_that_tenant_with_invalid_domain_names_returns_400(self, TenantDetector):
        ...
        invalid_datas = [
            ('domain_names', {'domain_names': ['-accentvoice.io']}),
            ('domain_names', {'domain_names': [' accentvoice.io']}),
            ...
            ('domain_names', {'domain_names': ['=accentvoice.io']}),
            ('domain_names', {'domain_names': ['+accentvoice.io']}),
            ('domain_names', {'domain_names': ['_accentvoice.io']}),
            ('domain_names', {'domain_names': ['accent_io']}),
            ('domain_names', {'domain_names': ['accent_io  ']}),
            ('domain_names', {'domain_names': ['']}),
        ]
        ...
        invalid_domains_types = [
            ...
            ('domain_names', {'domain_names': {'name': 'accentvoice.io'}}),
        ]
