...
from accent.config_helper import read_config_file_hierarchy_accumulating_list

TWO_HOURS = 60 * 60 * 2
_DEFAULT_HTTP_PORT = 9497
_DEFAULT_CONFIG = {
    'user': 'accent-auth',
    'config_file': '/etc/accent-auth/config.yml',
    'extra_config_files': '/etc/accent-auth/conf.d',
    'update_policy_on_startup': True,
    'debug': False,
    'log_level': 'info',
    'log_filename': '/var/log/accent-auth.log',
    ...
    'password_reset_from_name': 'accent-auth',
    'password_reset_from_address': 'noreply@accentvoice.io',
    'password_reset_email_template': '/var/lib/accent-auth/templates/password_reset_email.jinja',
    'password_reset_email_subject_template': '/var/lib/accent-auth/templates/password_reset_email_subject.jinja',  # noqa
    'email_confirmation_expiration': 172800,
    'email_confirmation_template': '/var/lib/accent-auth/templates/email_confirmation.jinja',
    'email_confirmation_subject_template': '/var/lib/accent-auth/templates/email_confirmation_subject.jinja',  # noqa
    'email_confirmation_from_name': 'accent-auth',
    'email_confirmation_from_address': 'noreply@accentvoice.io',
    'email_confirmation_get_response_body_template': '/var/lib/accent-auth/templates/email_confirmation_get_body.jinja',  # noqa
    'email_confirmation_get_mimetype': 'text/html',
    'oauth2_synchronization_ws_url_template': 'wss://oauth.accentvoice.io/ws/{state}',
    'oauth2_synchronization_redirect_url_template': 'https://oauth.accentvoice.io/{auth_type}/authorize',
    ...
    'db_uri': 'postgresql://asterisk:password123@localhost/asterisk',
